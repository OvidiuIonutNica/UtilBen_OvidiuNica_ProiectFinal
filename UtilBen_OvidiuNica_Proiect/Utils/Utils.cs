...
namespace UtilBen_OvidiuNica_Proiect.Utils
{
    public static class Utils
    {
        public static IWebElement FindElementWait(this IWebDriver driver, By by, int timeout = 7)
        {
        ...
        public static void SelectFromDropDown(IWebElement dropDown, string optionValue, string selectBy)
        {
